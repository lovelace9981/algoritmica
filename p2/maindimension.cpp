...
int main(int argc, char *argv[]){
	...
	int tamanio_caso = 0;
	DCDDIMENSION<int>* no_dominados_ptr;
	...
	for (int i = 4 ; i < argc; i++){
		...
		no_dominados_ptr = new DCDDIMENSION<int>(k_dimension, tamanio_caso, 100);
		cerr << "Ejecutando algoritmo recursivo DyV enfocado a coordenadas para tam " << tamanio_caso << endl ;
